...
# Use the user's intent value
intents = discord.Intents(321611512152832)
...
async def get_voice_player(interaction: discord.Interaction, connect: bool = True) -> tuple[Optional[wavelink.Player], Optional[str]]:
    """Get or create voice player with user's intent value"""
    guild_id = interaction.guild.id
    
    # Check existing player via wavelink
    try:
